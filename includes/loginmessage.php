<?php 
    if(isset($_SESSION['loginmessage']) && isset($_SESSION['loginstatus'])):
?>

<div id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    <?php if($_SESSION['loginstatus'] == "danger"):?>
    ...
    <?php endif ?>
    <div class="ms-3 text-sm font-normal"><?= $_SESSION['loginmessage'] ?></div>
