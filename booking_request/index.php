<?php
    ...
    ) ORDER BY s.status,s.date_requested"; 
                ...
                <tbody>
                    <?php foreach ($reservation_records as $record): ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-2 py-4">
                                <?php if($record['status'] == 0):?>
                                    <a href="./manage.php?reserveId=<?= $record['id'] ?>" id="record-<?= $record['id']?>" class="focus:outline-none text-white bg-blue-500 hover:bg-blue-500 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 cancel-reservation-btn">Manage</a>  
                                <?php else: ?>
                                    <p>No longer Pending</p>
                                <?php endif ?>                         
                            </td>
                        </tr>
                    <?php endforeach; ?>                 
