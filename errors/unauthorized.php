...
<body class="dark bg-gray-900">
    ...
    <main class="flex justify-center items-center px-4" style="margin-top: 50px;margin-bottom: 50px;">
        <div class="max-w-xl p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-red-700 dark:text-red-500">You are unauthorized</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">It seems like you are entering a page that requires a privileged account</p>
