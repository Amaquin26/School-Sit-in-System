        ...
        <div class="mt-5 w-full mx-auto p-4 max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex justify-end px-4 pt-4">
                ...
                <div id="dropdown" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 w-full" aria-labelledby="dropdownButton">
                        <li>
                            <a href="./edit.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Edit Profile</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="text-sm font-medium text-gray-700 dark:text-gray-500 pb-5">
                <p class="my-1">Email: <?= $_SESSION['email']?></p>
                <p class="my-1">Contact: <?= $_SESSION['contact']?></p>
                <p class="my-1">Address: <?= $_SESSION['address']?></p>
